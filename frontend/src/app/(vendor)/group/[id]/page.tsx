...
export default function GroupDetailsPage() {
    ...
    const { data, showQuantityModal } = useAppStore();
    const groupId = params.id as string;

    const groupBuy = data.group_buys.find(gb => gb.id === groupId);
    ...
    return (
        <div className="p-4 sm:p-6 pb-24 bg-gray-100">
            <Link href="/dashboard" className="text-orange-600 font-semibold mb-4 flex items-center">&larr; Back to all groups</Link>
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-5">
                    ...
                    <Button onClick={() => showQuantityModal(groupBuy)} className="mt-8">Place Order</Button>
                </div>
            </div>
        </div>
    );
