...
export default function CreateGroupBuyPage() {
    ...
    return (
        <div className="p-4 sm:p-6 pb-24 bg-gray-50">
            <Link href="/dashboard" className="text-orange-600 font-semibold mb-6 flex items-center">&larr; Back to Dashboard</Link>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-lg space-y-6">
                <div>
                    ...
                    <select 
                        id="product_id" 
                        required
                        className="mt-1 block w-full px-4 py-3 bg-gray-100 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-base"
                    >
                ...
                <Input id="title" label="Group Buy Title (Optional)" type="text" placeholder="e.g., Bulk Onions for August" />
